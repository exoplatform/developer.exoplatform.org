---
title: STB-0010
tagline: Never redefine Maven defaults configuration and settings
permalink: /standards/STB-0010/
author: aheritier
tags: [maven]
controlsSeverity:
status: draft
...
Excepted for a good reason validated with the SWF Team all projects should follow maven standards :

  * Directories layout
  * Default variables to configure plugins
...
http://maven.apache.org/maven-v4_0_0.xsd"
  ...
  <name>STB-0010 : Wrong sample 01</name>
// TBD
</project>
{% endhighlight %}
...
http://maven.apache.org/maven-v4_0_0.xsd"
      ...
      <version>1.0.0-SNAPSHOT</version>
      <packaging>jar</packaging>
      <name>STB-0010 : Good sample 01</name>
    // TBD
    </project>
{% endhighlight %}
