---
title: STB-0004
tagline: Use profiles to adapt to build-time context, not run-time context, and not (with rare exceptions) to produce alternative versions of your artifact
permalink: /standards/STB-0004/
author: aheritier
tags: [maven]
controlsSeverity:
status: draft
...
http://maven.apache.org/maven-v4_0_0.xsd"
  ...
  <name>STB-0004 : Wrong sample 01</name>
// TBD
</project>
{% endhighlight %}
...
http://maven.apache.org/maven-v4_0_0.xsd"
      ...
      <version>1.0.0-SNAPSHOT</version>
      <packaging>jar</packaging>
      <name>STB-0004 : Good sample 01</name>
    // TBD
    </project>
{% endhighlight %}
