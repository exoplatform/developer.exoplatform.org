...
*This strategy is applied to all repositories/projects involved in eXo products.* Others projects are using a single repository hosted on "exoplatform" organization.
  ...
  <div class="span5">!/assets/docs/scm/git-organization.png!</div>
</div>
...
!/assets/docs/scm/git-branches.png!
		</div>
</div>
...
!/assets/docs/scm/git-merge-without-ff.png!
...
Now your contribution is pushed in dedicated branch on development repository, you can do a pull request. On github project page (dev repository) click on !/assets/docs/scm/git-pull-request.png! and ask  the merge from @fix/A.B.x/PROJECT-12345@ (development repository) to @stable/A.B.x@ (blessed repository).

!/assets/docs/scm/git-pull-request-creation.png!
...
!/assets/docs/scm/git-jira-pull-request.png!
