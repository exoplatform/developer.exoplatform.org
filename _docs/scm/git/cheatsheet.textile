...
permalink: /docs/scm/git/cheatsheet/
redirect_from:
  - /docs/scm/git-cheatsheet.html
tags: [git]
---

<div class="row">
  <div class="col-md-12">
    <img src="{{BASE_PATH}}/assets/images/docs/scm/git-overview.png" class="img-responsive img-thumbnail" alt="Git Big Picture">
  </div>
</div>
...
Convention for messages inspired by "this article":http://tbaggery.com/2008/04/19/a-note-about-git-commit-messages.html :
