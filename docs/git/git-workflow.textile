...
* The *repository architecture** (development vs blessed) that has to be followed by *all projects involved in products* produced eXo
...
Now your contribution is pushed in dedicated branch on development repository, you can do a pull request. On github project page (dev repository) click on !git-pull-request.png! and ask  the merge from @fix/A.B.x/PROJECT-12345@ (development repository) to @stable/A.B.x@ (blessed repository).

!=git-pull-request-creation.png!
