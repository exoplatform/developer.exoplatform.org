...
Due to the migration process you'll find in the new Git repository corresponding to your project in SVN various branches you didn't have.

These branches may have various origins :

## It has the name of a tag. This is because in SVN history you edited a tag (It's BAAAAAD). Thus the conversion process considered that you started a branch and then you did a tag.
**TODO : Decide what we do with them**
...
**TODO : Links and synchro with Git Norms @ eXo**
...
TODO : Issue with projects inheriting from eXo Parent POM < 2
