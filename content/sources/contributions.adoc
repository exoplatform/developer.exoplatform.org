...
When contributing code, the best practices defined in https://docs.google.com/spreadsheets/d/1s-op62uot1dy4YwMA-JswxNg0DwS4sdmg1eAll0VHIU[this file] must be considered.
...
The reviewer must check the PR follows the best practices described in the https://docs.google.com/spreadsheets/d/1s-op62uot1dy4YwMA-JswxNg0DwS4sdmg1eAll0VHIU[eXo Development Best Practices].

The reviewer must also check the compliance with following guidelines documents:
* https://community.exoplatform.com/portal/intranet/wiki/group/spaces/engineering/REST_CRUD_APIs[REST APIs guidelines] 
* https://community.exoplatform.com/portal/intranet/wiki/group/spaces/engineering/RDBMS_Guidelines[RDBMS guidelines]
