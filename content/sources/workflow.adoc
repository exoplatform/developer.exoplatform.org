...
image::git-workflow-develop-branch.png[alt="git workflow develop branch", width="1000"]
...
image::git-workflow-feature-branch.png[alt="git workflow feature branch", width="300"]
...
image::git-workflow-fix-branch.png[alt="git workflow fix branch", width="400"]
...
image::git-workflow-stable-branch.png[alt="git workflow stable branch", width="800"]
...
image::git-workflow-poc-branch.png[alt="poc branches workflow", width="300")]
