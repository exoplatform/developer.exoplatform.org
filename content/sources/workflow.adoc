...
image::../../images/git-organization.png[alt="git repositories")]
...
image::../../images/git-workflow-develop-branch.svg[alt="git workflow develop branch"), width="1000"]
...
image::../../images/git-workflow-feature-branch.svg[alt="git workflow feature branch"), width="300"]
...
image::../../images/git-workflow-fix-branch.svg[alt="git workflow fix branch"), width="400"]
...
image::../../images/git-workflow-stable-branch.svg[alt="git workflow stable branch"), width="800"]
...
image::../../images/git-workflow-integration-branch.png[alt="git workflow integration branch"), width="1000"]
...
image::../../images/prepare-intermediate-Release.png[alt="Intermediate Release process", width="600")]
...
image::../../images/prepare-final-Release.png[alt="Final Release process", width="500")]
